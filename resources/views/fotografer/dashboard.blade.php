...
<div class="row g-3 mb-4">
    ...
    <div class="col-xl-3 col-md-6">
        <a href="{{ route('fotografer.laporan.create') }}" class="quick-action-card" style="display: block; background: linear-gradient(135deg, #191c24 0%, #1f2332 100%); border: 1px solid #2c2e33; border-radius: 16px; padding: 28px; text-decoration: none; transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); height: 100%; position: relative; overflow: hidden;">
            <div style="position: absolute; top: 0; right: 0; width: 80px; height: 80px; background: linear-gradient(135deg, rgba(255, 171, 0, 0.1) 0%, rgba(255, 171, 0, 0.05) 100%); border-radius: 0 16px 0 50px;"></div>
            <div class="icon" style="width: 64px; height: 64px; border-radius: 16px; background: linear-gradient(135deg, #ffab00 0%, #ffeaa7 100%); display: flex; align-items: center; justify-content: center; margin-bottom: 20px; box-shadow: 0 6px 20px rgba(255, 171, 0, 0.4); position: relative; z-index: 1;">
                <i class="bi bi-file-earmark-plus" style="font-size: 28px; color: #ffffff;"></i>
            </div>
            <h5 style="font-size: 18px; font-weight: 700; color: #ffffff; margin-bottom: 10px; position: relative; z-index: 1;">Buat Laporan</h5>
            <p style="font-size: 14px; color: #6c7293; margin: 0; line-height: 1.6; position: relative; z-index: 1;">Buat laporan kegiatan baru</p>
        </a>
    </div>
    <div class="col-xl-3 col-md-6">
...
<div class="row g-3">
                            ...
                            <tr style="border-bottom: 1px solid #2c2e33; transition: all 0.3s ease;">
                                <td style="padding: 22px 24px;">
                                    <div class="user-cell" style="display: flex; align-items: center; gap: 14px;">
                                        <img src="https://ui-avatars.com/api/?name={{ urlencode($pesanan->user->name ?? 'U') }}&background=6c5ce7&color=fff&size=128&bold=true" 
                                             alt="user" 
                                        ...
                                        <div>
                                            <div style="font-size: 15px; font-weight: 600; color: #ffffff; margin-bottom: 3px;">{{ $pesanan->user->name ?? 'Unknown' }}</div>
    ...
    <div class="col-xl-4">
        ...
        <div class="card" style="background: linear-gradient(135deg, #191c24 0%, #1a1e26 100%); border: 1px solid #2c2e33; border-radius: 20px; box-shadow: 0 8px 30px rgba(0, 0, 0, 0.2); overflow: hidden;">
            <div class="card-body" style="padding: 0;">
                <div class="card-title" style="padding: 28px 28px 24px; border-bottom: 1px solid #2c2e33; margin: 0; background: linear-gradient(135deg, rgba(0, 210, 91, 0.05) 0%, rgba(0, 210, 91, 0.02) 100%);">
                    <h5 style="font-size: 20px; font-weight: 700; color: #ffffff; margin: 0; display: flex; align-items: center; gap: 12px;">
                        <div style="width: 40px; height: 40px; background: linear-gradient(135deg, #00d25b 0%, #55efc4 100%); border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                            <i class="bi bi-file-text" style="color: #ffffff; font-size: 18px;"></i>
                        </div>
                        Laporan Terakhir
                    </h5>
                    <p style="font-size: 13px; color: #6c7293; margin: 8px 0 0;">3 laporan terbaru</p>
                </div>
                <div style="padding: 24px; max-height: 350px; overflow-y: auto;">
                    <ul class="activity-list" style="list-style: none; padding: 0; margin: 0;">
                        @forelse($laporanTerbaru ?? [] as $laporan)
                        <li style="display: flex; align-items: flex-start; padding: 20px 0; border-bottom: 1px solid #2c2e33; transition: all 0.3s ease;">
                            <div class="activity-icon" style="width: 48px; height: 48px; border-radius: 14px; background: linear-gradient(135deg, rgba(0, 210, 91, 0.2) 0%, rgba(0, 210, 91, 0.1) 100%); display: flex; align-items: center; justify-content: center; margin-right: 16px; flex-shrink: 0; box-shadow: 0 4px 12px rgba(0, 210, 91, 0.2);">
                                <i class="bi bi-file-check" style="color: #00d25b; font-size: 20px;"></i>
                            </div>
                            <div class="activity-content" style="flex: 1; min-width: 0;">
                                <h6 style="font-size: 15px; font-weight: 700; color: #ffffff; margin: 0 0 8px; line-height: 1.4;">{{ $laporan->judul }}</h6>
                                <p style="font-size: 13px; color: #6c7293; margin: 0 0 8px; line-height: 1.5;">{{ Str::limit($laporan->ringkasan ?? '', 35) }}</p>
                                <div style="display: flex; align-items: center; gap: 8px; margin-top: 10px;">
                                    <div style="width: 28px; height: 28px; background: rgba(0, 210, 91, 0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                                        <i class="bi bi-calendar3" style="color: #00d25b; font-size: 12px;"></i>
                                    </div>
                                    <span style="font-size: 12px; color: #6c7293; font-weight: 500;">{{ \Carbon\Carbon::parse($laporan->tanggal)->format('d M Y') }}</span>
                                </div>
                            </div>
                        </li>
                        @empty
                        <li style="text-align: center; padding: 60px 20px;">
                            <div style="width: 80px; height: 80px; background: rgba(0, 210, 91, 0.1); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px;">
                                <i class="bi bi-file-x" style="font-size: 40px; color: #00d25b;"></i>
                            </div>
                            <h6 style="font-size: 18px; font-weight: 700; color: #ffffff; margin-bottom: 10px;">Belum ada laporan</h6>
                            <p style="font-size: 14px; color: #6c7293; margin: 0;">Laporan akan muncul di sini</p>
                        </li>
                        @endforelse
                    </ul>
                </div>
