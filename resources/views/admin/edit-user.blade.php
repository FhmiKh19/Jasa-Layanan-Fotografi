...
<div class="d-flex justify-content-between align-items-center mb-4">
  <div>
    <h3 class="fw-bold mb-1 d-flex align-items-center">
      <i data-lucide="edit" class="me-2 text-primary"></i>Edit User
    </h3>
    <p class="text-muted mb-0">Edit data user (Admin, Fotografer, atau Pelanggan)</p>
  </div>
    ...
    <div class="card form-card border-0 shadow-sm">
      <div class="card-header bg-white">
        <h5 class="fw-bold mb-0 d-flex align-items-center">
          <i data-lucide="users" class="me-2"></i>Form Edit User
        </h5>
      </div>
      <div class="card-body">
        @if(session('success'))
        ...
        <form action="{{ route('admin.users.update', $user->id_pengguna) }}" method="POST">
          @csrf
          @method('PUT')
          ...
          <div class="row">
            ...
            <div class="col-md-12 mb-3">
              ...
              <select name="role" 
                ...
                <option value="fotografer" {{ old('role', $user->role) == 'fotografer' ? 'selected' : '' }}>Fotografer</option>
          ...
          <div class="alert alert-info d-flex align-items-center">
            ...
            <div>
              <strong>Catatan:</strong> Password bersifat opsional. Isi hanya jika ingin mengubah password.
            </div>
          </div>
